...
|-------|----------|--------|
| `agent` | yes | `scope-collector`, `code-python`, `code-typescript`, `docs`, `intent`, `tests`, `structure`, `leaks`, `security`, `performance`, `infra-yaml` |
...
```json
{
  ...
  "triggers": {"leaks": true, "security": false, "performance": false, "structure": true, "infra": false},
  "workflow": {
    "codename": "alpha",
