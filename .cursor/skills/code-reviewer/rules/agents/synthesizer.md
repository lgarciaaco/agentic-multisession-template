...
3. Resolve conflicts: security or infra-yaml BLOCKER beats performance SUGGESTION; prefer specific agent over code-agent duplicate
...
6. Verdict:
   - **FAIL**: any BLOCKER (code, security, or infra-yaml agents)
