---
name: hub-upgrade
description: Check template version vs upstream and upgrade hub scripts/hooks/docs in place. Use when user asks about template version or hub upgrade.
---
...
Triggers: `template version`, `hub upgrade`, `upgrade hub`, `upgrade`
